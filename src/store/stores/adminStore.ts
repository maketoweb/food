...
type AdminSection = 'reports' | 'orders' | 'tracking' | 'inventory' | 'tables' | 'customers' | 'coupons' | 'settings' | 'branding' | 'sedes' | 'extras' | 'notifications' | 'chat' | 'promos' | 'combos' | 'loyalty' | 'content';
